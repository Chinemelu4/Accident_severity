...
# encode using ordinal encoder and predict
    ...
    # predict the target from all the input features
        ...
        st.write("Developed By: Ezinwanne Chinemelu Aka")
        st.markdown("""Reach out to me on: [Twitter](https://twitter.com/aka_chineme) |
        [Linkedin](https://www.linkedin.com/in/ezinwanne-chinemelu-aka-97b187120/) |
        """)
